// Set favicon
document.querySelector("link[rel~='icon']").href = chrome.runtime.getURL("../assets/twitter-jackbutcher-favicon.png");
...
waitForElement('[aria-label="Twitter"]').then((elm) => {
  ...
  twitterIcon.src = chrome.runtime.getURL("../assets/twitter-jackbutcher.png");
